...
saveContractBtn.addEventListener('click', function(){
    ...
    let birthdayPerson = document.querySelector('.birthday_person').innerText;
    ...
    document.querySelector('input[name=birthday_personInput]').value = birthdayPerson;
...
let sendBirthdayPerson = document.getElementById('sendBirthdayPerson');
sendBirthdayPerson.addEventListener('keyup', function(){
    let birthdayPersons = document.querySelectorAll('.birthday_person');
    for(let i = 0; i < birthdayPersons.length; i++){
        if(sendBirthdayPerson.value == ''){
            birthdayPersons[i].innerText = '(Nome do aniversariante)';
            birthdayPersons[i].classList.add('mark');
        }else{
            birthdayPersons[i].innerText = sendBirthdayPerson.value;
            birthdayPersons[i].classList.remove('mark');
        }
    }
})
