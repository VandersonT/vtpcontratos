...
<head>
    ...
    <link rel="stylesheet" href="<?=$base;?>/assets/css/contracts/birthday1.css" />
...
<body>
    ...
    <form class="fillMenu animate__animated">    
        ...
        <input id="sendBirthdayPerson" type="text" placeholder="Nome do aniversariante" value="<?= ($contract->id > 1 && $contract->birthday_person != '(Nome do aniversariante)') ? $contract->bride : '' ?>"/>

        <input id="sendDate" type="text" placeholder="data do aniversário" value="<?= ($contract->id > 1 && $contract->date != '(Data)') ? $contract->date : '' ?>"/>

        <input id="sendTime" type="text" placeholder="Hora do aniversário" value="<?= ($contract->id > 1 && $contract->time != '(Horario)') ? $contract->time : '' ?>"/>
    ...
    <div class="contractSingle">
        ...
        <div class="spaceBottom2x">
            <span class="bold">Nome do Aniversariante:</span>
            <span contentEditable="true" class="birthday_person <?= ($contract->birthday_person == '(Nome do aniversariante)') ? 'mark' : '' ?> marginRight1x"><?=$contract->birthday_person;?></span>
        </div>
        ...
        <div class="spaceBottom2x">
            ...
            <span contentEditable="true" class="birthday_person <?= ($contract->birthday_person == '(Nome do aniversariante)') ? 'mark' : '' ?>"><?=$contract->birthday_person;?></span>
    ...
    <form class="formSaveContract" method="POST" action="<?=$base;?>/salvar/birthday1">
        ...
        <input name="birthday_personInput" type="hidden"/>
    ...
    <script src="<?=$base;?>/assets/js/contracts/birthday1.js"></script>
